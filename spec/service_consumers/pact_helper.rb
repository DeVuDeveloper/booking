...
Pact.service_provider "Vespa Service" do
  honours_pact_with "Vespas GraphQL Query" do
    ...
    pact_uri File.expand_path("../pacts/bikes_ui-vespas_graphql_query.json", __dir__)
  end
end
